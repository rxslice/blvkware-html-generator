...
def product_cards() -> dict:
    ...
    return {
        ...
        "sample-kit": {
            "eyebrow": "Free sample kit",
            "title": "A complete AI agent kit.<br><em>Every file, free.</em>",
            "sub": "A real Follow-Up Agent kit, generated by the same code as a paid one. "
                   "Read it before you design yours.",
            "pills": ["Free", "Read or download"],
            "terminal": kit_tree(),
            "url": "blvkware.dev/sample-kit",
        },
        "agents": {
            "eyebrow": "The catalog",
