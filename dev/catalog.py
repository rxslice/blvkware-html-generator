...
CAPABILITIES = [
    ...
    _c("approval.console", "Control", "Approval console",
       "A queue where anything it wants to do waits for a human yes. This is what the Approve level runs on.",
       1100, 2,
    ...
    _c("dashboard", "Control", "Reporting dashboard",
       "A live view of what it did, what it recovered, and where it escalated.",
       1400, 3,
